...
+ (instancetype)cellWithTableView:(UITableView *)tableView DataSource:(NSDictionary *) dataSource {
    FATableViewCell * cell;
    bool answerOrQuestion = [dataSource objectForKey:@"answer"] != nil;
    NSString * reusableCellID = answerOrQuestion ? @"findAnswerID" : @"findQuestionID";
    cell = [tableView dequeueReusableCellWithIdentifier:reusableCellID];
    if (cell == nil) {
        if (answerOrQuestion) {
            cell = [[FATableViewCell alloc] setupAnswerCellwithQuestion:[dataSource objectForKey:@"question"] Answer:[dataSource objectForKey:@"answer"] Author:[dataSource objectForKey:@"author"] Price:[dataSource objectForKey:@"price"]];
        } else {
            cell = [[FATableViewCell alloc] setupQuestionCellwithQuestion:[dataSource objectForKey:@"question"] Description:[dataSource objectForKey:@"description"] Author:[dataSource objectForKey:@"author"] Price:[dataSource objectForKey:@"price"]];
        }
    }
    return cell;
}
...
- (FATableViewCell*) setupAnswerCellwithQuestion:(NSString *)question Answer:(NSString *) answer Author:(NSString *) author Price:(NSString *) price {
    FATableViewCell * cell = [[FATableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"findAnswerID"];
...
- (FATableViewCell*) setupQuestionCellwithQuestion:(NSString *)question Description:(NSString *) description Author:(NSString *) author Price:(NSString *) price {
    FATableViewCell * cell = [[FATableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"findQuestionID"];
